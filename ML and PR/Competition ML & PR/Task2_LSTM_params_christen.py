...
def RNN(train_data, val_data, train_labels, val_labels, X_test):
    ...
    model = Sequential()
    model.add(LSTM(25, return_sequences = True, input_shape = train_data.shape[1:], kernel_regularizer=regularizers.l1(0.0001), activity_regularizer=regularizers.l1(0.0001)))
    model.add(BatchNormalization())
    
    model.add(LSTM(25, kernel_regularizer=regularizers.l1(0.0001), activity_regularizer=regularizers.l1(0.0001)))
    model.add(BatchNormalization())
